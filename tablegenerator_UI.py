...
class Ui_TableGenerate(object):
    def setupUi(self, TableGenerate):
        ...
        self.pdf_check = QtWidgets.QCheckBox(TableGenerate)
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(13)
        self.pdf_check.setFont(font)
        self.pdf_check.setObjectName("pdf_check")
        self.pdf_check.setGeometry(QtCore.QRect(550, 530, 151, 32))
        self.pdf_check.setText("生成PDF")
        ...
        self.status_label.setGeometry(QtCore.QRect(10, 530, 531, 31))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(13)
