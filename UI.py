...
class Ui_TableGenerate(object):
    def setupUi(self, TableGenerate):
        ...
        self.comboBox = QtWidgets.QComboBox(self.ocr_tab)
        self.comboBox.setGeometry(QtCore.QRect(440, 10, 121, 31))
    ...
    def retranslateUi(self, TableGenerate):
        ...
        TableGenerate.setWindowTitle(_translate("TableGenerate", "Table Generator  v1.2"))
        ...
        self.comboBox.setItemText(1, _translate("TableGenerate", "龙航"))
        self.comboBox.setItemText(2, _translate("TableGenerate", "顺捷"))
        self.comboBox.setItemText(3, _translate("TableGenerate", "林翔"))
